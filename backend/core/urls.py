...
urlpatterns = [
    ...
    path('targets/<int:pk>/subdomains/', views.target_subdomains, name='target_subdomains'),
    path('targets/<int:pk>/webapps/', views.target_webapps_page, name='target_webapps'),
    path('targets/<int:pk>/vulnerabilities/', views.target_vulnerabilities, name='target_vulnerabilities'),
